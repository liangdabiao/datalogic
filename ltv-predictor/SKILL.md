...
name: ltv-predictor
title: 客户生命周期价值预测技能
description: 基于RFM模型和回归算法的客户生命周期价值(LTV)预测分析工具，支持电商和零售业务的客户价值预测
author: Claude Code
version: 1.0.0
allowed-tools: ["Read", "Write", "Edit", "Bash", "Glob", "Grep", "WebSearch"]
tags: ["ltv", "prediction", "regression", "rfm", "customer-analytics", "ecommerce"]
examples:
  - title: 电商LTV预测完整示例
    description: 使用电商订单数据进行RFM分析和LTV预测的完整流程
    file: examples/ecommerce_ltv_analysis.py
  - title: 快速LTV预测
    description: 对新客户进行快速LTV预测分析
    file: examples/quick_ltv_prediction.py
---
