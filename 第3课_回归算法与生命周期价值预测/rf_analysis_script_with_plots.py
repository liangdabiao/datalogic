...
plt.legend()
plt.savefig('E:/ai-in-practice-main/第3课_回归算法与生命周期价值预测/rf_prediction_plot.png')
plt.close() # 关闭图形以释放内存
print("预测效果散点图已保存为 rf_prediction_plot.png")
...
plt.savefig('E:/ai-in-practice-main/第3课_回归算法与生命周期价值预测/rf_feature_importance.png')
plt.close() # 关闭图形以释放内存
